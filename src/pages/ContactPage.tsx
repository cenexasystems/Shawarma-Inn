...
export default function ContactPage() {
  ...
  return (
    <main className="min-h-screen bg-[var(--black)] text-white pt-24 pb-12 flex flex-col">
      <SEO 
        title="Contact Us | Shawarma Inn"
        description="Have questions or need help with your order? Reach out to Shawarma Inn instantly via WhatsApp or visit our Mathur outlet."
