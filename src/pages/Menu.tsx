...
export default function Menu({ cartData }: MenuProps) {
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://shawarmainn.in/"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Menu",
        "item": "https://shawarmainn.in/menu"
      }
    ]
  };
  ...
  return (
    <main className="pt-[64px] min-h-screen bg-[var(--black)]">
      <SEO 
        title="Our Menu | Shawarma Inn"
        description="Explore our menu featuring flame grilled chicken shawarma, wraps, combo offers, and mojitos at Shawarma Inn."
        keywords="chicken shawarma Mathur, shawarma wraps Chennai, flame grilled shawarma Chennai, mojito Mathur, shawarma combo offers Chennai"
        canonicalUrl="/menu"
