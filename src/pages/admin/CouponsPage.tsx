...
export default function CouponsPage() {
 ...
 return (
 <div className="min-h-screen bg-[#fafafa] font-inter p-8 ">
 {/* Header Area */}
 <div className="mb-6">
 ...
 />
 <button onClick={generateCode} className="shrink-0 bg-[#2b4236] hover:bg-[#1a2921] text-white px-6 rounded-[12px] text-[11px] font-[800] uppercase tracking-widest transition-colors h-[48px]">
 Generate
 </button>
 </div>
 </div>
 ...
 <div className="text-[14px] font-[700] text-gray-900 flex items-center gap-2">
 ...
 <div className="text-[12px] text-gray-500 font-[500] flex items-center gap-2">
