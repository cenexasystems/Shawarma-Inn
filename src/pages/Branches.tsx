...
export default function Branches() {
  ...
  const localBusinessSchema = {
    ...
    "url": "https://shawarmainn.in/branches",
  ...
  return (
    <main className="pt-[80px] min-h-screen bg-[var(--black)]">
      <SEO 
        title="Our Branches | Shawarma Inn Locations"
        description="Find the nearest Shawarma Inn sanctuary for your nocturnal cravings. Visit our flagship store in Mathur."
        keywords="shawarma near mathur, Shawarma Inn locations"
